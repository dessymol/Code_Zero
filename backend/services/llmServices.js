...
function buildFeedbackPrompt({ code, languageName, question, judgeResult, score, maxScore, testSummary }) {
...
${
        ...
        (testSummary)
            ? `\nTest results: ${testSummary.passed} of ${testSummary.total} test cases passed.` +
            (testSummary.failedExamples.length > 0
                ? '\nFailed examples:\n' + testSummary.failedExamples
